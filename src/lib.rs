...
#[derive(Debug)]
pub struct BassHingeProcessor {
    verbose: bool,
    processed_count: usize,
}

impl BassHingeProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting BassHinge processing");
    
    let mut processor = BassHingeProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = BassHingeProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = BassHingeProcessor::new(false);
